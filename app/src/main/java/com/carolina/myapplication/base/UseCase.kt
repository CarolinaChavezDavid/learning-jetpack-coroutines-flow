package com.carolina.myapplication.base

import android.os.Parcelable
import androidx.appcompat.app.AppCompatActivity
import com.carolina.myapplication.usecases.coroutines.usecase1.PerformSingleNetworkRequestActivity
import com.carolina.myapplication.usecases.coroutines.usecase10.CalculationInBackgroundActivity
import com.carolina.myapplication.usecases.coroutines.usecase11.CooperativeCancellationActivity
import com.carolina.myapplication.usecases.coroutines.usecase12.CalculationInSeveralCoroutinesActivity
import com.carolina.myapplication.usecases.coroutines.usecase13.ExceptionHandlingActivity
import com.carolina.myapplication.usecases.coroutines.usecase14.ContinueCoroutineWhenUserLeavesScreenActivity
import com.carolina.myapplication.usecases.coroutines.usecase15.WorkManagerActivity
import com.carolina.myapplication.usecases.coroutines.usecase16.PerformanceAnalysisActivity
import com.carolina.myapplication.usecases.coroutines.usecase17.PerformCalculationOnMainThreadActivity
import com.carolina.myapplication.usecases.coroutines.usecase2.Perform2SequentialNetworkRequestsActivity
import com.carolina.myapplication.usecases.coroutines.usecase2.callbacks.SequentialNetworkRequestsCallbacksActivity
import com.carolina.myapplication.usecases.coroutines.usecase2.rx.SequentialNetworkRequestsRxActivity
import com.carolina.myapplication.usecases.coroutines.usecase3.PerformNetworkRequestsConcurrentlyActivity
import com.carolina.myapplication.usecases.coroutines.usecase4.VariableAmountOfNetworkRequestsActivity
import com.carolina.myapplication.usecases.coroutines.usecase5.NetworkRequestWithTimeoutActivity
import com.carolina.myapplication.usecases.coroutines.usecase6.RetryNetworkRequestActivity
import com.carolina.myapplication.usecases.coroutines.usecase7.TimeoutAndRetryActivity
import com.carolina.myapplication.usecases.coroutines.usecase7.callbacks.TimeoutAndRetryCallbackActivity
import com.carolina.myapplication.usecases.coroutines.usecase7.rx.TimeoutAndRetryRxActivity
import com.carolina.myapplication.usecases.coroutines.usecase8.RoomAndCoroutinesActivity
import com.carolina.myapplication.usecases.coroutines.usecase9.DebuggingCoroutinesActivity
import com.carolina.myapplication.usecases.flow.usecase1.FlowUseCase1Activity
import com.carolina.myapplication.usecases.flow.usecase2.FlowUseCase2Activity
import com.carolina.myapplication.usecases.flow.usecase3.FlowUseCase3Activity
import com.carolina.myapplication.usecases.flow.usecase4.FlowUseCase4Activity
